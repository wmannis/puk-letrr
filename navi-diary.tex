...
In addition to the daily production practice, you can go back and read
earlier entries for comprehension practice.  Over time, you can also
start to see your improvements in the language.
...
\marginnote{You could also use \N{slu} ``become'' instead of just
  \N{lu} ``be.''}
...
Any of these statements can be negated by putting \N{ke} \textit{not}
...
\N{slu} ``become'' & \N{sle\uline{ru}}  & \N{sla\uline{mu}}
     & \N{sla\uline{yu}}  \\
