...
words when I define them in the notes (it's where the stress accent
goes).  But it is in no way necessary for you to have mastered the
grammar at this point. \marginnote{I'm going to wave my hands for some
  ...
  beginners, this is a normal part of language instruction.}
A little conversational knowledge, and just the start of some grammar
is enough.  The diary itself can act as a grammar training ground.
...
the sentence, and maybe workshop it on a Na'vi language forum or in
...
\marginnote{For complete discussion of Na'vi weather vocabulary, see
  Paul Frommer's blog:
  ...
  I'll not be including everything here.}
